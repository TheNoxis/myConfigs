...
alias kcurl="kubectl run curl-tmp -it --rm --image=nicolaka/netshoot --restart=Never -- curl -k "
alias kdig="kubectl run dig-tmp -it --rm --image=nicolaka/netshoot --restart=Never -- dig "
