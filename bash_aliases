...
alias kcurl="kubectl run curl-tmp -it --rm --image=${K8S_IMAGE_TOOLS:-nicolaka/netshoot} --restart=Never -- curl -k "
alias kdig="kubectl run dig-tmp -it --rm --image=${K8S_IMAGE_TOOLS:-nicolaka/netshoot} --restart=Never -- dig "
...
# Vault CRD
alias kglvss="kubecolor get vaultstaticsecrets.secrets.hashicorp.com -o yaml"
alias kglvds="kubecolor get vaultdynamicsecrets.secrets.hashicorp.com -o yaml"
alias kglvcs="kubecolor get vaultconnections.secrets.hashicorp.com -o yaml"
alias kglvas="kubecolor get vaultauth.secrets.hashicorp.com -o yaml"
alias kglvags="kubecolor get vaultauthglobals.secrets.hashicorp.com -o yaml"
alias kglvps="kubecolor get vaultpkisecrets.secrets.hashicorp.com -o yaml"
# GET -------------------------------
...
alias klj="kubecolor get job --sort-by='.metadata.creationTimestamp'"
...
# Vault CRD
alias klvss="kubecolor get vaultstaticsecrets.secrets.hashicorp.com"
alias klvds="kubecolor get vaultdynamicsecrets.secrets.hashicorp.com"
alias klvcs="kubecolor get vaultconnections.secrets.hashicorp.com"
alias klvas="kubecolor get vaultauth.secrets.hashicorp.com"
alias klvags="kubecolor get vaultauthglobals.secrets.hashicorp.com"
alias klvps="kubecolor get vaultpkisecrets.secrets.hashicorp.com"
## DESCRIBE -----------------------------
...
# Vault CRD
alias kevss="kubecolor edit vaultstaticsecrets.secrets.hashicorp.com"
alias kevds="kubecolor edit vaultdynamicsecrets.secrets.hashicorp.com"
alias kevcs="kubecolor edit vaultconnections.secrets.hashicorp.com"
alias kevas="kubecolor edit vaultauth.secrets.hashicorp.com"
alias kevags="kubecolor edit vaultauthglobals.secrets.hashicorp.com"
alias kevps="kubecolor edit vaultpkisecrets.secrets.hashicorp.com"
