...
# LIST with GET -------------------
alias klcm="kubecolor get configmap -o yaml"
alias klcrb="kubecolor get ClusterRoleBinding -o yaml"
alias klcrd="kubecolor get crd -o yaml"
alias klcsr="kubecolor get csr -o yaml"
alias kld="kubecolor get deployments -o yaml"
alias klds="kubecolor get daemonset -o yaml"
alias kle="kubecolor get events  -o yaml"
# alias kle="kubecolor get events --sort-by='.metadata.creationTimestamp'"
alias kli="kubecolor get ingress -o yaml"
alias klir="kubecolor get ingressRoute -o yaml"
alias klj="kubecolor get job -o yaml"
alias kln="kubecolor get nodes -o yaml"
alias klnp="kubecolor get networkpolicies -o yaml"
alias klns="kubecolor get namespaces -o yaml"
alias klp="kubecolor get pods -o yaml"
alias klpv="kubecolor get pv -o yaml"
alias klpvc="kubecolor get pvc -o yaml"
alias klr="kubecolor get role -o yaml"
alias klrb="kubecolor get rolebinding -o yaml"
alias kls="kubecolor get services -o yaml -o yaml"
alias klsec="kubecolor get secret -o yaml"
alias klsa="kubecolor get serviceaccounts -o yaml"
alias klsfs="kubecolor get statefulsets -o yaml"
alias klvs="kubecolor get volumesnapshots -o yaml"
alias klvsc="kubecolor get volumesnapshotcontents -o yaml"
# GET -------------------------------
...
alias kgir="kubecolor get ingressRoute -o wide"
...
alias kds="kubecolor describe rc,services"
